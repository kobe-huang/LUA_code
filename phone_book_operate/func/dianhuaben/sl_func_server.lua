...
--                                      --
--                                      --
--20170224  13:28:24     kobe package 
--                                      --
--                                      --
--                                      --
------------------------------------------
...
--web服务器的地址
default_server_addr = "http://120.76.215.162/sl_base/addons/xsy_resource/gettask.php?task="
...
------------------end:  ./lib/lib_JSON.lua-------------------------------------




----------------------begin:  ./misc/ms_info.lua---------------------------------
...
------------------end:  ./misc/ms_info.lua-------------------------------------




----------------------begin:  ./misc/file_log.lua---------------------------------
require "string"
--获取路径  
...
function logFileInit()   
    ...
    local file_path = strip_file_name(sl_log_file)
...
------------------end:  ./misc/file_log.lua-------------------------------------




----------------------begin:  ./class/class_server.lua---------------------------------
--服务器返回的数据：
--{Code = 101, Message = "OK", 
...
------------------end:  ./class/class_server.lua-------------------------------------




----------------------begin:  ./class/class_ms.lua---------------------------------
